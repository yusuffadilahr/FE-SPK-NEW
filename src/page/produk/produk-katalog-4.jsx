...
const Produk_Katalog_4 = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://localhost:3001/api-v1/product/kategori/2'); // Pastikan mengganti '1' dengan ID kategori yang sesuai
...
export default Produk_Katalog_4;